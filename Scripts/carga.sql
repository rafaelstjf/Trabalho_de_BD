...
values ('12345678900', NULL, 0, 1, 'Joao da Silva', 'joaodasilva@hotmail.com', '123456'); /*Pessoa*/

insert into trab.pessoa (cpf, cnpj, tipo, cod_endereco, nome, email, senha)
values (NULL, '312239281892384', 1, 2, 'Fornecedor Nota 1000', 'nota1000@hotmail.com', '1000'); /*Fornecedor*/
