...
<?php
	...
	$consulta= mysql_query("SELECT nomeCliente FROM reservas WHERE origem='BH' AND destino='SP' ORDER BY nomeCliente",$conexao);
	...
	echo "<table class='admin' width='500px'>
		...
		<tr class='tituloadmin'>
			<td align='center'>Origem: BH</td>
			<td align='center'>Destino: SP</td>
		</tr>
